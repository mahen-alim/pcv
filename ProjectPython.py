...
# Form implementation generated from reading ui file 'ProjectPython.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1074, 602)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(20, 30, 501, 461))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.tableWidget_2 = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget_2.setGeometry(QtCore.QRect(550, 30, 511, 461))
        ...
        self.actionInves = QtWidgets.QAction(MainWindow)
        self.actionInves.setObjectName("actionInves")
        self.actionLog_Brightness = QtWidgets.QAction(MainWindow)
        self.actionLog_Brightness.setObjectName("actionLog_Brightness")
        self.actionGamma_Corection = QtWidgets.QAction(MainWindow)
        self.actionGamma_Corection.setObjectName("actionGamma_Corection")
        ...
        self.actionHistogram_Qualization = QtWidgets.QAction(MainWindow)
        self.actionHistogram_Qualization.setObjectName("actionHistogram_Qualization")
        ...
        self.actionHeigh_Pass_Filter = QtWidgets.QAction(MainWindow)
        self.actionHeigh_Pass_Filter.setObjectName("actionHeigh_Pass_Filter")
        ...
        self.menuColors.addAction(self.actionInves)
        self.menuColors.addAction(self.actionLog_Brightness)
        self.menuColors.addAction(self.menuBit_Depth.menuAction())
        self.menuColors.addAction(self.actionGamma_Corection)
        self.menuImage_Processing.addAction(self.actionHistogram_Qualization)
        ...
        self.menuFilter.addAction(self.actionHeigh_Pass_Filter)
        ...
        self.menuErosion.addAction(self.actionCross)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionInves.setText(_translate("MainWindow", "Inves"))
        self.actionLog_Brightness.setText(_translate("MainWindow", "Log Brightness"))
        self.actionGamma_Corection.setText(_translate("MainWindow", "Gamma Corerction"))
        ...
        self.actionHistogram_Qualization.setText(_translate("MainWindow", "Histogram Equalization"))
        ...
        self.actionHeigh_Pass_Filter.setText(_translate("MainWindow", "Heigh Pass Filter"))
